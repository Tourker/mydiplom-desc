...
* [Этапы:](#Этапы)
     ...
     * [Устанавливаем и настраиваем CI/CD](#Устанавливаем-и-настраиваем-CI/CD)
...
Заходим через IP-адресс loadbalancer указывая порт 3000 и заходим в Dashboard/General/Kubernetes/Compute Resources/Cluster
